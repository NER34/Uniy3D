...
public class CellGenerator : MonoBehaviour
{
    ...
    private int numOfReadyClients = 0;
    ...
    private void Start()
    {
        ...
        eventOptions = new RaiseEventOptions { Receivers = ReceiverGroup.Others };
    ...
    {
        numOfReadyClients++;
        if (numOfReadyClients == PhotonNetwork.PlayerList.Length - 1)
            ready = true;
    }
    ...
    private void FixedUpdate()
    {
        ...
        PhotonNetwork.RaiseEvent(8, changedCells.ToArray(), eventOptions, sendOptions);
        NextGeneration();
